...
一种消息队列，是实现 AMQP（高级消息队列协议）的消息中间件的一种。
...
![img](http://www.belonk.com/attachment/20180404/7974866d38ce484fb56e47e7d1cc8c38.png)
...
- 路由键必须是一串字符，用句号（`.`） 隔开，比如说 [agreements.us](http://agreements.us)，或者 agreements.eu.stockholm 等。
